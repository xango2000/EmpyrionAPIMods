    ...
    public class MyEmpyrionMod : ModInterface
    {
        ...
        */
        ...
        public class Permission
        {
            ...
            {
                Permissions Parameters = new XangosAPIToolModule.XangosAPITool.Permissions();
        ...
        public void Game_Event(CmdId cmdId, ushort seqNr, object data)
        {
            try
            {
                switch (cmdId)
                {
                    ...
                    case CmdId.Event_Player_Connected: //Not Mod Triggered
                        Id pc = (Id)data;
                        GameAPI.Game_Request(CmdId.Request_Player_Info, (ushort)CmdId.Request_Player_Info, new Id(pc.id));
                        ...
                        break;
                    case CmdId.Event_Player_Disconnected: //Not Mod Triggered
                        Id pd = (Id)data;
                    ...
                    case CmdId.Event_Player_Info:
                        ...
                        if (PlayerInfoReceived.steamId == "76561198117632903") //"Godmode" for Xango while testing mod
                        {
                            GameAPI.Game_Request(CmdId.Request_Player_SetPlayerInfo, (ushort)CmdId.Request_Player_SetPlayerInfo, new Eleon.Modding.PlayerInfoSet()
                            {
                                ...
                                oxygen = Convert.ToInt32(PlayerInfoReceived.oxygenMax),
                                radiation = 0,
                                food = Convert.ToInt32(PlayerInfoReceived.foodMax),
                                stamina = Convert.ToInt32(PlayerInfoReceived.staminaMax),
                                bodyTemp = 30,
                                health = Convert.ToInt32(PlayerInfoReceived.healthMax)
                            });
                        }
                        if (ItemExchangeSwitch.ContainsKey(PlayerInfoReceived.entityId))
                        {
                            if (ItemExchangeSwitch[PlayerInfoReceived.entityId].StartsWith("/bp"))
                            {
                                if (seqNr == 1167)
                                {
                                    List<string> UserSIDList = NameFragment("blank " + PlayerInfoReceived.entityId);
                    ...
                    case CmdId.Event_Player_ItemExchange:
                        ...
                        if (ItemExchangeSwitch.ContainsKey(exchangeInfo.id)) //This is the new version, now do parse
                        {
                            ...
                            if (Message[0].StartsWith("/bp"))
                            {
                                ...
                                System.IO.File.WriteAllText("Content\\Mods\\Xango\\players\\SID" + PlayerDictionary[UserSIDList[0]].SteamID + "\\VirtualBackpack.txt", string.Empty);
                                for (int i = 0; i <= exchangeInfo.items.Count(); i++)
                                {
                                    ...
                                    LogFile("players\\SID" + PlayerDictionary[UserSIDList[0]].SteamID + "\\VirtualBackpack.txt", Convert.ToString(exchangeInfo.items[i].slotIdx) + "," + Convert.ToString(exchangeInfo.items[i].id) + "," + Convert.ToString(exchangeInfo.items[i].count) + "," + Convert.ToString(exchangeInfo.items[i].ammo) + "," + Convert.ToString(exchangeInfo.items[i].decay));
                    ...
                    case CmdId.Event_Player_Credits:
                        break;
                    case CmdId.Event_Player_ChangedPlayfield: //Not Mod Triggered
                        //WIP
                    ...
                    case CmdId.Event_Playfield_Stats:
                        ...
                        break;
                    case CmdId.Event_Playfield_Loaded: //Not Mod Triggered
                        try
                        {
                        ...
                        break;
                    case CmdId.Event_Playfield_Unloaded: //Not Mod Triggered
                        break;
                    ...
                    case CmdId.Event_Entity_PosAndRot:
                        break;
                    case CmdId.Event_Faction_Changed: //Not Mod Triggered
                        /*
                    ...
                    case CmdId.Event_Get_Factions:
                        ...
                        */
                        break;
                    case CmdId.Event_Statistics: //Not Mod Triggered
                        StatisticsParam StatsParam = (StatisticsParam)data;
                        //if (StatsParam.type == "StructOnOff")
                    ...
                    case CmdId.Event_NewEntityId:
                        break;
                    case CmdId.Event_Player_DisconnectedWaiting: //Not Mod Triggered
                        Id pdw = new Id();
                        LogFile("ERROR.txt", "FAILED LOGIN:  Player=" + pdw.id);
                        break;
                    case CmdId.Event_ChatMessage: //Not Mod Triggered
...
*/
                    ...
                    case CmdId.Event_BannedPlayers:
                        break;
                    case CmdId.Event_TraderNPCItemSold: //Not Mod Triggered
                        break;
                    case CmdId.Event_Ok:
                        /*
